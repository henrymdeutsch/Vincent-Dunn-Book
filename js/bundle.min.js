...
!function (t, e) {
    ...
    function l(o) {
        for (let t = 1; t < arguments.length; t++) {
            let r = null != arguments[t] ? arguments[t] : {}, e = Object.keys(r);
    ...
    let m = {
        TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
            ...
            if (!t) return 0;
            let e = p(t).css("transition-duration"), n = p(t).css("transition-delay"), i = parseFloat(e),
                o = parseFloat(n);
    ...
    let o = "alert", r = "bs.alert", a = "." + r, c = p.fn[o],
        ...
        f = "fade", d = "show", g = function () {
            ...
            return t.close = function (t) {
                ...
                let e = m.getSelectorFromElement(t), n = !1;
    ...
    let _ = "button", v = "bs.button", y = "." + v, E = ".data-api", b = p.fn[_], w = "active", C = "btn", T = "focus",
        ...
        k = function () {
            ...
            return t.toggle = function () {
                let t = !0, e = !0, n = p(this._element).closest(D)[0];
                if (n) {
    ...
    let L = "carousel", x = "bs.carousel", P = "." + x, H = ".data-api", j = p.fn[L],
